...
public class startTermsOfService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_terms_of_service);

termstextv = findViewById(R.id.startterms);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(startTermsOfService.this, StartActivity.class);
