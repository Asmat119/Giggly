...
public class startPrivacyPolicy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startPrivacy = findViewById(R.id.startprivacy);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(startPrivacyPolicy.this, StartActivity.class);
